...
func (mc *MyClient) updatePenaltyData(w http.ResponseWriter, r *http.Request) {
	setupResponse(w, r)
	var err error
	var data PenaltyData
	err = json.NewDecoder(r.Body).Decode(&data)
...
func (mc *MyClient) selectPenaltyData(w http.ResponseWriter, r *http.Request) {
	setupResponse(w, r)
	podcastsCollection := mc.db.Collection("penalty")
	ctx, cancel := context.WithTimeout(context.Background(), 10*time.Second)
	defer cancel()
...
func (mc *MyClient) selectPenaltyDataOne(w http.ResponseWriter, r *http.Request) {
	setupResponse(w, r)
	var data PenaltyData
	r.ParseForm()
...
func (mc *MyClient) deletePenaltyData(w http.ResponseWriter, r *http.Request) {
	setupResponse(w, r)
	var err error
